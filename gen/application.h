...
void app_complete_scan_connect (
    App *object,
    GDBusMethodInvocation *invocation);

void app_complete_connect (
    App *object,
    GDBusMethodInvocation *invocation);

void app_complete_disconnect (
    App *object,
    GDBusMethodInvocation *invocation);

void app_complete_advertise (
    App *object,
    GDBusMethodInvocation *invocation);

void app_complete_create_adv (
    App *object,
    GDBusMethodInvocation *invocation);
...
void app_call_scan_connect (
    App *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean app_call_scan_connect_finish (
    App *proxy,
    GAsyncResult *res,
    GError **error);

gboolean app_call_scan_connect_sync (
    App *proxy,
    GCancellable *cancellable,
    GError **error);

void app_call_connect (
    App *proxy,
    const gchar *arg_devAddress,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean app_call_connect_finish (
    App *proxy,
    GAsyncResult *res,
    GError **error);

gboolean app_call_connect_sync (
    App *proxy,
    const gchar *arg_devAddress,
    GCancellable *cancellable,
    GError **error);

void app_call_disconnect (
    App *proxy,
    const gchar *arg_devAddress,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean app_call_disconnect_finish (
    App *proxy,
    GAsyncResult *res,
    GError **error);

gboolean app_call_disconnect_sync (
    App *proxy,
    const gchar *arg_devAddress,
    GCancellable *cancellable,
    GError **error);

void app_call_advertise (
    App *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean app_call_advertise_finish (
    App *proxy,
    GAsyncResult *res,
    GError **error);

gboolean app_call_advertise_sync (
    App *proxy,
    GCancellable *cancellable,
    GError **error);

void app_call_create_adv (
    App *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean app_call_create_adv_finish (
    App *proxy,
    GAsyncResult *res,
    GError **error);

gboolean app_call_create_adv_sync (
    App *proxy,
    GCancellable *cancellable,
    GError **error);
